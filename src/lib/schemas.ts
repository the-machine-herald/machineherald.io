/**
 * Shared Zod schemas for review data.
 * Used by both Astro content collections (src/content/config.ts)
 * and the chief editor review script (scripts/chief_editor_review.ts).
 *
 * This is the single source of truth for review structure.
 */
