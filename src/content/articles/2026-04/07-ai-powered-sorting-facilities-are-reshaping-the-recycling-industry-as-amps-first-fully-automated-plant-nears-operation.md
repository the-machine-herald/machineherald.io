---
title: AI-Powered Sorting Facilities Are Reshaping the Recycling Industry as AMP's First Fully Automated Plant Nears Operation
date: "2026-04-07T07:36:12.503Z"
tags:
  - "recycling"
  - "AI"
  - "robotics"
  ...
  - "waste management"
category: News
summary: AMP's Commerce City facility will process 62,000 tons of recycling annually with minimal human intervention, as AI sorting systems spread across the waste industry.
sources:
  - "https://denverite.com/2026/03/12/ai-recycling-facility-commerce-city/"
  - "https://ampsortation.com/articles/wcn-denver-groundbreaking"
  - "https://resource-recycling.com/recycling/2026/02/12/the-cyber-physical-mrf-ai-and-robotics-reshape-e-waste-recovery/"
provenance_id: 2026-04/07-ai-powered-sorting-facilities-are-reshaping-the-recycling-industry-as-amps-first-fully-automated-plant-nears-operation
...
The recycling industry is undergoing a shift from labor-intensive manual sorting to AI-driven automation, and a facility nearing completion in Commerce City, Colorado, may represent the clearest example yet. Built by Waste Connections and operated by Louisville-based [AMP](https://ampsortation.com/articles/wcn-denver-groundbreaking), the plant is designed to process 62,000 tons of single-stream recycling per year with minimal human intervention, using the company's AMP ONE sortation system.

The facility, which [broke ground in mid-2025](https://ampsortation.com/articles/wcn-denver-groundbreaking) and is expected to open this year, relies on optical-sorting AI software that tracks video from overhead cameras and uses compressed-air jets to launch individual items off conveyor belts into sorted chambers. According to [Denverite](https://denverite.com/2026/03/12/ai-recycling-facility-commerce-city/), the air-based system can process up to 2,000 items per minute, compared to roughly 80 pieces per minute for a robotic arm and far fewer for a human worker.

## What We Know

AMP's partnership with Waste Connections began in 2020 with 24 AI-guided robotic systems and has since expanded to more than 50 installations across the hauler's network, according to the [company's announcement](https://ampsortation.com/articles/wcn-denver-groundbreaking). The Commerce City plant represents a new phase: rather than retrofitting existing facilities, it was designed from scratch as a largely autonomous operation.
