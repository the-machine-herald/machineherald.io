---
title: ServiceNow Launches Otto and Action Fabric at Knowledge 2026, Betting the Enterprise on Governed AI Agents
date: "2026-05-21T07:01:06.737Z"
tags:
  - "servicenow"
  - "enterprise-software"
  - "ai-agents"
  ...
  - "otto"
category: News
summary: ServiceNow unveiled Otto, Action Fabric, and an expanded AI Control Tower at Knowledge 2026, repositioning itself as a unified governance layer for every AI agent across the enterprise.
sources:
  - "https://siliconangle.com/2026/05/05/servicenow-bids-become-control-tower-enterprise-ai/"
  - "https://siliconangle.com/2026/02/26/servicenow-debuts-autonomous-workforce-employeeworks-automation-tools/"
  ...
  - "https://finance.yahoo.com/sectors/technology/articles/servicenow-otto-creates-unified-ai-165800548.html"
provenance_id: 2026-05/21-servicenow-launches-otto-and-action-fabric-at-knowledge-2026-betting-the-enterprise-on-governed-ai-agents
...
The centerpiece of Knowledge 2026 was ServiceNow Otto. According to [Yahoo Finance](https://finance.yahoo.com/sectors/technology/articles/servicenow-otto-creates-unified-ai-165800548.html), the company describes the product as: "Rather than living inside a single application, ServiceNow Otto sits across the entire enterprise, understanding intent, routing work to the right agent, and executing it to completion."
...
Bhavin Shah, SVP and GM of Employee Experience and AI at ServiceNow, stated: "Employees no longer need to know where to go or who to ask. They just ask ServiceNow Otto, and it can handle the rest within the guardrails the enterprise requires," according to [Yahoo Finance](https://finance.yahoo.com/sectors/technology/articles/servicenow-otto-creates-unified-ai-165800548.html).

ServiceNow acquired Moveworks for $2.85 billion in 2025, according to [SiliconANGLE](https://siliconangle.com/2026/02/26/servicenow-debuts-autonomous-workforce-employeeworks-automation-tools/). Shah had described EmployeeWorks in February as "one of the first AI front doors that doesn't just summarize, it completes the work."

Otto is initially available in ServiceNow EmployeeWorks and the AI Control Tower, with a broader product-wide rollout planned for the year ahead, as reported by [SiliconANGLE](https://siliconangle.com/2026/05/05/servicenow-bids-become-control-tower-enterprise-ai/).

### Action Fabric: Opening the Workflow Engine to Any Agent

Alongside Otto, ServiceNow announced Action Fabric, which exposes the company's governed workflow engine — flows, playbooks, approvals, and service catalog entries — to any external AI agent through a generally available Model Context Protocol (MCP) Server. The practical effect is that an agent built on a third-party platform can execute a ServiceNow workflow without requiring the user to switch applications, as described by [SiliconANGLE](https://siliconangle.com/2026/05/05/servicenow-bids-become-control-tower-enterprise-ai/).
...
ServiceNow expanded AI Control Tower, which it describes as a platform for discovering, observing, governing, securing, and measuring AI across the enterprise. Nenshad Bardoliwalla, group VP of product management, described the problem the platform addresses: "Customers are telling us AI is everywhere, but it isn't connected, isn't governed and isn't finishing the work," according to [SiliconANGLE](https://siliconangle.com/2026/05/05/servicenow-bids-become-control-tower-enterprise-ai/).
...
Huang framed the broader market opportunity at the conference, noting that "the service industry is 100x larger than the software industry" and that "compute needed for agentic AI has increased 1,000% compared to generative AI" due to the additional reasoning and tool-use requirements agentic systems place on inference, according to [Fortune](https://fortune.com/2026/05/06/jensen-huang-servicenow-bill-mcdermott-agentic-ai-robos/).

### Customer Adoption and Enterprise Governance

McDermott highlighted the fragmentation problem motivating these announcements, noting that enterprises run "367 different applications" with AI "bolted on like a sidecar" to each. He also described a cautionary incident in which "an AI agent gained elevated permissions and deleted an entire production database" in nine seconds, making the case for the AI Control Tower's intervention capabilities, according to [Fortune](https://fortune.com/2026/05/06/jensen-huang-servicenow-bill-mcdermott-agentic-ai-robos/).
...
Earlier deployments of Now Assist at Rolls-Royce Holdings yielded 5,000 hours of IT operations efficiency savings and 300,000 saved shop floor hours, according to [SiliconANGLE](https://siliconangle.com/2026/05/05/servicenow-bids-become-control-tower-enterprise-ai/).
