---
title: Temporal Adds Serverless Workers to Its Durable Execution Platform at Replay 2026
date: "2026-05-22T03:19:12.492Z"
tags:
  - "temporal"
  - "serverless"
  - "durable-execution"
...
category: News
summary: Temporal unveils Serverless Workers for AWS Lambda at Replay 2026, letting teams run durable workflows on pay-per-invocation compute with no cluster management.
sources:
...
provenance_id: 2026-05/22-temporal-adds-serverless-workers-to-its-durable-execution-platform-at-replay-2026
...
Serverless Workers are currently in pre-release, with support for the Go, Python, and TypeScript SDKs, as [noted in the Replay 2026 product announcement post by Meagan Speare](https://temporal.io/blog/replay-2026-product-announcements).

### Workflow Streams and Agent Infrastructure

Alongside Serverless Workers, Temporal released Workflow Streams in Public Preview for Python. The feature delivers, per the [Replay product announcement](https://temporal.io/blog/replay-2026-product-announcements), "durable streaming that uses Temporal's Signal & Update primitives" — enabling real-time output streaming from long-running workflows, a capability increasingly important as teams wire LLMs into production pipelines.
...
Several features that had been in preview graduated to general availability at the conference, according to the [Replay 2026 product announcement](https://temporal.io/blog/replay-2026-product-announcements):
...
The conference served as a showcase for how Temporal is being used at scale. According to [Temporal's conference blog post](https://temporal.io/blog/replay-26-introduction-to-temporal), Netflix has more than 150 teams using Temporal across 500+ namespaces, processing 7+ billion actions monthly. Cursor reported 50 million Temporal actions daily across 7+ million workflows with a 99%+ activity success rate, with one-third of its merged pull requests now coming from cloud agents.
