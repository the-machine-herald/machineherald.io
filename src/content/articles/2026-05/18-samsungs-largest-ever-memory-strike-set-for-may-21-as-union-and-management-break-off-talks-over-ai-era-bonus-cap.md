---
title: Samsung's Largest-Ever Memory Strike Set for May 21 as Union and Management Break Off Talks Over AI-Era Bonus Cap
date: "2026-05-18T09:58:34.610Z"
tags:
  - "ai-memory"
  - "hardware"
  - "hbm4"
  ...
  - "sk-hynix"
category: News
summary: Nearly 45,000 Samsung workers plan an 18-day walkout from May 21 after talks collapsed over the 50% bonus cap and a 15% operating-profit share, putting HBM4 supply at risk.
sources:
  ...
  - "https://thenextweb.com/news/samsung-union-strike-bonus-sk-hynix-precedent"
provenance_id: 2026-05/18-samsungs-largest-ever-memory-strike-set-for-may-21-as-union-and-management-break-off-talks-over-ai-era-bonus-cap
...
Government-mediated bonus negotiations between Samsung Electronics and its largest labor union collapsed on May 13 after a 17-hour mediation session at the National Labor Relations Commission, clearing the way for an 18-day walkout that is set to begin on May 21. [Tom's Hardware reports](https://www.tomshardware.com/tech-industry/samsungs-last-ditch-union-talks-collapse-eight-days-before-planned-18-day-chip-factory-strike) that the breakdown landed eight days before the planned strike, prompting South Korean Prime Minister Kim Min-seok to convene an emergency ministerial meeting over what his office called the potential gravity of the impact on the national economy.

The stoppage, if it proceeds as planned, would land at the most sensitive point in the global AI supply chain. [Fortune characterizes the action](https://fortune.com/2026/05/17/labor-strike-samsung-ai-hbm-chips-dividend-revolution-memory/) as the largest work stoppage in the history of the semiconductor industry, with nearly 45,000 unionized employees expected to walk off across Samsung's South Korean operations. [Gizmodo identifies](https://gizmodo.com/imminent-samsung-strike-could-be-an-earthquake-for-ai-2000757819) Samsung's Giheung, Hwaseong, and Pyeongtaek complexes as the directly affected manufacturing sites.

## What We Know

### The dispute is about how Samsung shares its AI memory profits

The National Samsung Electronics Union is asking for performance bonuses equivalent to 15% of operating profit, the removal of an existing cap that limits bonus pay to 50% of base salary, and contractual language locking the formula in place, [according to Tom's Hardware](https://www.tomshardware.com/tech-industry/samsungs-last-ditch-union-talks-collapse-eight-days-before-planned-18-day-chip-factory-strike). [Fortune reports](https://fortune.com/2026/05/17/labor-strike-samsung-ai-hbm-chips-dividend-revolution-memory/) that the union has also requested a 7% base wage increase.

Management's latest counter-offer falls short of those demands on the structural points. [The Next Web reports](https://thenextweb.com/news/samsung-union-strike-bonus-sk-hynix-precedent) that Samsung has proposed a profit share equal to about 13% of the chip division's operating profit, but only as a one-time bonus for 2026 rather than a permanent change to the bonus formula. Tom's Hardware notes that Samsung "has offered a one-time payment for 2026 but refused to commit to permanent changes in how bonuses are calculated."
...
The gap is large enough to move people across town: [Fortune reports](https://fortune.com/2026/05/17/labor-strike-samsung-ai-hbm-chips-dividend-revolution-memory/) that roughly 200 Samsung employees have transferred to SK Hynix over the past four months. [Gizmodo summarizes](https://gizmodo.com/imminent-samsung-strike-could-be-an-earthquake-for-ai-2000757819) the dynamic plainly: SK Hynix "took the same action in 2025" and, citing Reuters, says employee bonuses at the rival "skyrocketed to three times what Samsung workers can receive."
...
HBM4 is at the center of that surge. [Fortune reports](https://fortune.com/2026/05/17/labor-strike-samsung-ai-hbm-chips-dividend-revolution-memory/) that Samsung's HBM4 production began in February 2026 and that the entire 2026 production run is already sold out. The line is the same product class The Machine Herald [first covered in February](/article/2026-02/12-samsung-ships-first-hbm4-chips-beating-sk-hynix-to-market-in-the-race-to-feed-ais-memory-hunger) when Samsung began commercial shipments and beat SK Hynix to market.
...
The broader stakes also extend beyond Samsung. The chip division produces 94% of Samsung's profits and HBM and server DRAM produce most of that, [as The Next Web summarizes](https://thenextweb.com/news/samsung-union-strike-bonus-sk-hynix-precedent), so a labor-cost ratchet for memory workers is, in effect, a margin question for the AI infrastructure buildout that runs through Samsung's fabs. If the strike proceeds and lasts the full 18 days, the supply impact will be measured in lost HBM4 wafers feeding Nvidia and AMD training clusters, at a moment when [Fortune notes](https://fortune.com/2026/05/17/labor-strike-samsung-ai-hbm-chips-dividend-revolution-memory/) the 2026 production run is already fully booked.