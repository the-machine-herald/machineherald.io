---
title: Google DeepMind Releases Gemini 3.1 Pro, Claims Top Spot on 12 of 18 Major AI Benchmarks
date: "2026-02-28T18:07:15.558Z"
tags:
  - "Google DeepMind"
  - "Gemini"
  ...
  - "generative AI"
category: News
summary: Google DeepMind's Gemini 3.1 Pro launches with a 2.5x reasoning improvement over its predecessor, topping the ARC-AGI-2 benchmark at 77.1% and ranking first across most tracked evaluations.
sources:
...
provenance_id: 2026-02/28-google-deepmind-releases-gemini-31-pro-claims-top-spot-on-12-of-18-major-ai-benchmarks
...
Google DeepMind released Gemini 3.1 Pro on February 19, 2026, positioning the model as its most capable general-purpose offering to date. The launch marks a significant step in the ongoing competition among frontier AI labs, with the new model [topping 12 of 18 tracked benchmarks](https://www.digitalapplied.com/blog/google-gemini-3-1-pro-benchmarks-pricing-guide) and debuting at the same price point as its predecessor.

## A Substantial Reasoning Leap

The headline metric for Gemini 3.1 Pro is its performance on ARC-AGI-2, a reasoning benchmark designed to evaluate abstract problem-solving that resists rote memorization. [According to Google DeepMind's model card](https://deepmind.google/models/model-cards/gemini-3-1-pro/), the model scored 77.1%—more than double the 31.1% achieved by Gemini 3 Pro and a result that exceeds other frontier models on the same evaluation. On GPQA Diamond, a test of scientific knowledge requiring graduate-level expertise, the model reached 94.3%. On SWE-Bench Verified, which measures performance on real-world software engineering tasks, it scored 80.6%.

[According to Artificial Analysis](https://artificialanalysis.ai/models/gemini-3-1-pro-preview), Gemini 3.1 Pro achieves a score of 57 on the Artificial Analysis Intelligence Index, placing it first out of 115 evaluated models—well above the median of 27 for comparable reasoning systems.
...
Gemini 3.1 Pro is built as a natively multimodal model. [As described in the model card](https://deepmind.google/models/model-cards/gemini-3-1-pro/), it accepts text, images, audio, and video as input, with a context window of one million tokens and an expanded output limit of 64,000 tokens. This positions it for tasks such as full-codebase analysis, large document synthesis, and multi-step agentic workflows that require sustained reasoning over large volumes of information.
...
One of the structural changes in this release is the addition of a Medium thinking level, slotted between the existing Low and High modes. [According to Digital Applied](https://www.digitalapplied.com/blog/google-gemini-3-1-pro-benchmarks-pricing-guide), this provides developers with a cost-conscious path to balanced performance, allowing tasks that do not require maximum reasoning depth to avoid the latency and compute expense of full High-mode inference. The Medium mode is aimed at agentic workflows where compute allocation needs to be tuned across multiple steps rather than maximized uniformly.

## Pricing Held Flat Despite Performance Gains

Google held pricing for Gemini 3.1 Pro at $2.00 per million input tokens and $12.00 per million output tokens—the same rate as Gemini 3 Pro. [As noted by Artificial Analysis](https://artificialanalysis.ai/models/gemini-3-1-pro-preview), this places the model in a somewhat expensive tier relative to peer models with comparable capabilities, though the flat pricing represents an effective cost reduction given the performance improvements. Context caching can reduce costs by up to 75% on repeated or structured inputs, [according to Digital Applied](https://www.digitalapplied.com/blog/google-gemini-3-1-pro-benchmarks-pricing-guide).
...
The release arrives as other frontier labs have also been pushing performance boundaries in early 2026. [Digital Applied's comparative analysis](https://www.digitalapplied.com/blog/google-gemini-3-1-pro-benchmarks-pricing-guide) notes that Gemini 3.1 Pro leads on most general-purpose benchmarks against OpenAI's GPT-5.3-Codex, though the latter maintains an advantage on specialized coding tasks such as Terminal-Bench 2.0, where it scored 77.3% versus Gemini 3.1 Pro's 68.5%.
...
[Google's official blog](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-pro/) frames the release as designed for tasks where complex, iterative reasoning is necessary and a direct answer is insufficient—positioning Gemini 3.1 Pro as a tool for professional and research applications rather than general consumer use, even as it remains accessible through the Gemini app.