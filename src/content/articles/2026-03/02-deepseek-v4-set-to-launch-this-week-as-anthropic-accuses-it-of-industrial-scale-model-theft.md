---
title: DeepSeek V4 Set to Launch This Week as Anthropic Accuses It of Industrial-Scale Model Theft
date: "2026-03-02T19:33:56.282Z"
tags:
  - "deepseek"
  - "ai-models"
  - "china"
  ...
  - "multimodal"
category: Analysis
summary: DeepSeek's first major AI release in over a year arrives amid Anthropic allegations that the Chinese lab used 24,000 fake accounts and 16 million queries to extract Claude's capabilities.
sources:
  ...
  - "https://fortune.com/2026/02/24/anthropic-china-deepseek-theft-claude-distillation-copyright-national-security/"
  - "https://bloomberg.com/news/articles/2026-02-23/anthropic-says-deepseek-minimax-distilled-ai-models-for-gains"
provenance_id: 2026-03/02-deepseek-v4-set-to-launch-this-week-as-anthropic-accuses-it-of-industrial-scale-model-theft
...
According to reporting by the [Financial Times](https://www.ft.com) and [CNBC](https://www.cnbc.com/2026/02/23/deepseek-to-release-new-ai-model-a-rough-period-for-nasdaq-stocks-could-follow.html), DeepSeek plans to release V4 this week, marking the company's first major model launch since the R1 reasoning model debuted in January 2025. Sources familiar with the matter told CNBC that V4 is a "multimodal" system capable of generating text, images, and video—a significant architectural expansion beyond the text-focused V3 series.
...
The breakdown, as reported by [Fortune](https://fortune.com/2026/02/24/anthropic-china-deepseek-theft-claude-distillation-copyright-national-security/) and [CNBC](https://www.cnbc.com/2026/02/24/anthropic-openai-china-firms-distillation-deepseek.html), attributes more than 13 million exchanges to MiniMax, over 3.4 million to Moonshot AI, and a smaller share to DeepSeek. However, Anthropic noted that DeepSeek's queries were specifically targeted: the company focused on reasoning tasks, rubric-based grading useful for reinforcement learning reward models, and rewrites of politically sensitive material—suggesting a deliberate effort to extract capabilities relevant to training advanced reasoning and alignment systems, not simply to use Claude for ordinary tasks.

[Bloomberg](https://bloomberg.com/news/articles/2026-02-23/anthropic-says-deepseek-minimax-distilled-ai-models-for-gains) reported that Anthropic is urging "rapid, coordinated action" among AI companies and policymakers, framing the distillation campaigns as a national security concern given the potential for foreign state actors to acquire frontier AI capabilities without developing them from scratch.
