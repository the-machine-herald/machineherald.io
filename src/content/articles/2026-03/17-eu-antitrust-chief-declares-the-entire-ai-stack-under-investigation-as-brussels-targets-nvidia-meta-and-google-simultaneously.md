---
title: EU Antitrust Chief Declares the 'Entire AI Stack' Under Investigation as Brussels Targets Nvidia, Meta, and Google Simultaneously
date: "2026-03-17T12:26:23.256Z"
tags:
  - "antitrust"
  - "european-union"
  - "nvidia"
  ...
  - "digital-markets-act"
category: Analysis
summary: Teresa Ribera signals the EU will examine every layer of AI infrastructure for competition distortions, from chips to cloud to models.
sources:
  - "https://www.pymnts.com/cpi-posts/eu-antitrust-chief-raises-concerns-over-big-tech-control-of-ai/"
...
provenance_id: 2026-03/17-eu-antitrust-chief-declares-the-entire-ai-stack-under-investigation-as-brussels-targets-nvidia-meta-and-google-simultaneously
...
Under regulatory pressure, Meta reversed course on March 6, agreeing to a 12-month trial period during which rival AI providers can operate on WhatsApp in Europe, according to [TechCrunch](https://techcrunch.com/2026/03/05/meta-will-allow-rival-ai-chatbots-on-whatsapp-in-europe-but-for-a-fee/). The concession comes with per-message fees ranging from EUR 0.0490 to EUR 0.1323 depending on the country. The Commission has stated it is analyzing whether this pricing model constitutes a continuation of anticompetitive conduct by financial rather than technical means.

### Google's AI and Publisher Content

A separate investigation examines whether Google unfairly uses publisher content for its AI Overviews feature without proper consent or compensation. Research cited by the Commission indicates that AI-generated summaries have caused up to 80 percent fewer clickthroughs to original news sources, according to [TechPolicy.Press](https://www.techpolicy.press/reviewing-european-antitrust-activity-in-2025-and-what-it-all-means-for-2026/). The probe also extends to Google's exclusive use of YouTube content for AI model training, raising questions about whether vertical integration in data supply creates unfair advantages.
